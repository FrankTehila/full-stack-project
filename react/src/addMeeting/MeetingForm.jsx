...
const MeetingForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const meetingData = {
            ...
            isProjector: formData.get('projector') === 'on',
            isBoard: formData.get('board') === 'on'
        };

        try {
            const token = localStorage.getItem('token');
            const response = await axios.post(
                'https://localhost:7065/api/meeting/add',
                meetingData,
                {
            ...
            setErrorMessage('Error scheduling meeting. Please try again.');
        }
    };
